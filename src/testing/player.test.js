...
test('Create a player with type human and place 2 non-overlapping ships of legnths 2, and 3 respectively', () => {
    ...
    expect(newPlayer.gameBoard.ships).toHaveLength(2);
});
